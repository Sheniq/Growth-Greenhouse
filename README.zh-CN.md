...
Growth Greenhouse 是一个本地优先的 Windows 学习成长工具。用户创建自己真正想完成的学习目标，设置适合自己的每周时长，并可选择关联一个学习软件。应用从 [Patina](https://github.com/Ceceliaee/patina) 读取有效的前台使用时间，把这些积累转换为植物成长、完成花园和个人奖励。
